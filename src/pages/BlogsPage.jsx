    ...
    <div className="min-h-screen bg-slate-50 py-12 md:py-16">
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="mb-10 max-w-2xl">
          <h1 className="text-4xl font-extrabold text-slate-900">Blogs</h1>
          <p className="mt-3 text-lg text-slate-600">Practical advice from the ReadyNest team.</p>
          <PreferredSourcesButton className="mt-5 min-h-10" />
        </div>
