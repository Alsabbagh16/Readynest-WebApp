...
const REQUIRED_PERMISSIONS = [
  ...
  { key: 'vehicle_logistics.vehicles.manage', description: 'Create and edit vehicles and GPS mappings', module: 'Vehicle Logistics' },
  { key: 'vehicle_logistics.service_logs.manage', description: 'Manage vehicle maintenance records and files', module: 'Vehicle Logistics' },
